...
<%@ include file="/common/common_js.jsp"%>
	...
	var setting = {
		...
		$(function() {
			...
			//当结点默认选中选 成后，给树的setting.check.chkboxType赋值 { "Y":"ps" , "N":"ps"}
...
<BODY>
<form id="listByjson" action="${baseurl}/roleauth/permissionall.action" method="post"></form>
<form id="role_authorize_form" name="role_authorize_form" action="${baseurl}/roleauth/roleauthsubmit.action" method="post">
